...
const SECTIONS = [
  ...
  },
  {
    ...
    description: 'Add, edit, reorder, and publish/unpublish Math/Physics/Chemistry/Biology content.',
    href: null,
    cta: 'Coming in the next batch',
    status: 'planned' as const,
  },
  {
    title: 'Learners & Progress',
    description: 'See who has signed up, what they have completed, and quiz results.',
    href: null,
    cta: 'Coming in the next batch',
    status: 'planned' as const,
  },
  ...
  {
    title: 'Analytics',
    description: 'Most-read chapters, active learners, completion rates, hardest quiz questions.',
    href: null,
    cta: 'Coming in the next batch',
    status: 'planned' as const,
  },
