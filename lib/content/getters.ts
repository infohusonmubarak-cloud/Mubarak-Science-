...
import {
  chapter7BConcepts as chapter7BMathConcepts,
...
import {
  chapter9BConcepts as chapter9BMathConcepts,
  chapter9BFormulas as chapter9BMathFormulas,
} from '@/content/subjects/mathematics/b-level/chapter-9-introduction-to-vectors';
import {
  chapter10BConcepts as chapter10BMathConcepts,
  chapter10BFormulas as chapter10BMathFormulas,
} from '@/content/subjects/mathematics/b-level/chapter-10-trigonometry-advanced';
import {
  chapter11BConcepts as chapter11BMathConcepts,
...
import {
  chapter2CConcepts as chapter2CMathConcepts,
  chapter2CFormulas as chapter2CMathFormulas,
} from '@/content/subjects/mathematics/c-level/chapter-2-mathematical-induction';
import {
  chapter3CConcepts as chapter3CMathConcepts,
...
import {
  chapter5CConcepts as chapter5CMathConcepts,
...
import {
  chapter4APressureConcepts,
  chapter4APressureFormulas,
} from '@/content/subjects/physics/a-level/chapter-4-pressure';
import {
  chapter5AWorkEnergyConcepts,
  chapter5AWorkEnergyFormulas,
} from '@/content/subjects/physics/a-level/chapter-5-work-and-energy';
import {
  chapter6AHeatConcepts,
  chapter6AHeatFormulas,
} from '@/content/subjects/physics/a-level/chapter-6-heat-and-temperature';
import {
  chapter7AWaveConcepts,
  chapter7AWaveFormulas,
} from '@/content/subjects/physics/a-level/chapter-7-wave-and-sound';
import {
  chapter8ALightConcepts,
...
import {
  chapter11AQuantumConcepts,
  chapter11AQuantumFormulas,
} from '@/content/subjects/physics/a-level/chapter-11-quantum-and-atomic-physics';
import {
...
import {
  chapter8CInterferenceConcepts,
  chapter8CInterferenceFormulas,
} from '@/content/subjects/physics/c-level/chapter-8-interference-and-diffraction-of-light';
import {
  chapter9CCapacitorConcepts,
  chapter9CCapacitorFormulas,
} from '@/content/subjects/physics/c-level/chapter-9-capacitor-and-capacitance';
import {
  chapter10CElectricalConcepts,
  chapter10CElectricalFormulas,
} from '@/content/subjects/physics/c-level/chapter-10-electrical-energy-power-and-heating-effect';
import {
  chapter11CInductionConcepts,
...
const CONTENT_PACKS: Record<string, { concepts: Record<string, Concept>; formulas: Record<string, Formula> }> = {
  ...
  'a-level/pressure': { concepts: chapter4APressureConcepts, formulas: chapter4APressureFormulas },
  'a-level/work-and-energy': { concepts: chapter5AWorkEnergyConcepts, formulas: chapter5AWorkEnergyFormulas },
  ...
  'a-level/quantum-and-atomic-physics': { concepts: chapter11AQuantumConcepts, formulas: chapter11AQuantumFormulas },
  ...
  'c-level/interference-and-diffraction-of-light': { concepts: chapter8CInterferenceConcepts, formulas: chapter8CInterferenceFormulas },
